document.addEventListener('DOMContentLoaded', function() {
    const currentVersion = '81';
    document.getElementById('versionNumber').textContent = `#${currentVersion}`;
    ...
    fetch('https://api.github.com/repos/unsky-dev/unsky-dev.github.io/releases/latest')
        ...
        .then(data => {
            ...
            if (latestVersion !== currentVersion) {
                ...
                updateBanner.textContent = "Nouvelle version disponible ! Cliquez pour mettre à jour.";
